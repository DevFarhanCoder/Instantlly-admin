          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition whitespace-nowrap text-sm"
              >
                <Ticket className="w-4 h-4" />
                <span className="hidden sm:inline">Voucher Management</span>
